...
export class Choosse {
  ...
  constructor(params) {
    ...
    this.$header.classList.add('choosse', `${params.castomClass}`)
    this.$btnHeader.classList.add('choosse__btn-header', `${params.castomClass}__btn-header`)
    this.$title.classList.add('choosse__title', `${params.castomClass}__title`)
    this.$icon.classList.add('choosse__icon', `${params.castomClass}__icon`)
    this.$dropList.classList.add('choosse__list', `${params.castomClass}__list`)
    ...
    for (const item of params.list) {
      ...
      this.select.$box.classList.add('choosse__item', `${params.castomClass}__item`)
      this.select.$btnSelect.classList.add('choosse__btn-select', `${params.castomClass}__btn-select`)
      this.select.$contant.classList.add('choosse__select-contant', `${params.castomClass}__select-contant`)
  ...
  set selectedName(value) {
    ...
    if (this._selectedName) {
      this.$title.textContent = this._selectedName
      for (const select of this.listSelect) {
        select.selected = false
        if (select.name == this._selectedName) select.selected = true
      }
    }
  }
